...
label_specialty = Label(frame_left, text="Select Specialty:")
...
label_doctor = Label(frame_left, text="Select Doctor:")
...
label_patient = Label(frame_left, text="Select Patient:")
...
treeview = ttk.Treeview(frame_right, columns=("ID", "Doctor", "Patient", "Date", "Time"), show="headings")
